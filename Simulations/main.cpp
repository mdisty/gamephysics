...
#define DIFFUSION_SPRING_SYSTEM
...
void initTweakBar(){
	...
	TwDefine(" TweakBar color='141 82 192' alpha=100 ");
...
#endif
#ifdef DIFFUSION_SPRING_SYSTEM
	g_pSimulator = new DiffusionSpringSystemSimulator();
#endif
	g_pSimulator->reset();
